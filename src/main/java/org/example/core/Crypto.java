...
public class Crypto {
	private static String defaultKey = "aafd12f328cae52876b480e2089ddec2f06cb58faafd12f6";
    ...
    public static void main(String[] args) {
        ...
        String x = new Crypto().performEncrypt("123456");
        System.out.println(x);
        
        x = new Crypto().performDecrypt("15660fc073e91cf2be9e4f2aa622351e");
        System.out.println(x);
    }
}